          ...
          <div class="list__item-header" style="background-color: ${note.color}">
            ...
            <div class="list__buttons">
              <div class="list__favorites-button">
                <img class="image ${note.favorites ? "hidden" : ""}"  src="../img/heart-inactive16.svg" alt="heart" >
                <img class="image ${note.favorites ? "" : "hidden"}"  src="../img/heart-active16.svg" alt="black heart">
              </div>
